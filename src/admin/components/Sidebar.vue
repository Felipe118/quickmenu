  ...
  <transition name="slide">
    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto px-4 py-2 space-y-2">
        <SidebarItem title="Dashboard" to="/app" @click="handleNavigate" />
        <SidebarItem title="Restaurante">
          <template #submenu>
            <SidebarItem title="Cadastro" to="/app/restaurante/cadastro" @click="handleNavigate" />
            <SidebarItem title="Restaurantes" to="/app/restaurante/listagem" @click="handleNavigate" />
          </template>
        </SidebarItem>
